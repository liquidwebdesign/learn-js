...
function estimateTotal(event) {
	...
	var btlExtra = parseInt($('#txt-q-extra').val(),10) || 0,
	btlCold = parseInt($('#txt-q-cold').val(),10) || 0,
	btlGarlic = parseInt($('#txt-q-garlic').val(),10) || 0,
	btlLemon = parseInt($('#txt-q-lemon').val(),10) || 0,
	state = $('#s-state').val();
